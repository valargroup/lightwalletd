...
type InspireParams struct {
	...
	PolyLen           uint64 `protobuf:"varint,1,opt,name=polyLen,proto3" json:"polyLen,omitempty"`                     // Polynomial length (e.g., 2048)
	DbDim1            uint64 `protobuf:"varint,2,opt,name=dbDim1,proto3" json:"dbDim1,omitempty"`                       // First database dimension
	Instances         uint64 `protobuf:"varint,3,opt,name=instances,proto3" json:"instances,omitempty"`                 // Number of PIR instances
	DbRows            uint64 `protobuf:"varint,4,opt,name=dbRows,proto3" json:"dbRows,omitempty"`                       // Database rows
	DbCols            uint64 `protobuf:"varint,5,opt,name=dbCols,proto3" json:"dbCols,omitempty"`                       // Database columns
	Gamma             uint64 `protobuf:"varint,6,opt,name=gamma,proto3" json:"gamma,omitempty"`                         // Gamma parameter
	InterpolateDegree uint64 `protobuf:"varint,7,opt,name=interpolateDegree,proto3" json:"interpolateDegree,omitempty"` // Interpolation degree
	PtModulus         uint64 `protobuf:"varint,8,opt,name=ptModulus,proto3" json:"ptModulus,omitempty"`                 // Plaintext modulus
	C                 uint64 `protobuf:"varint,9,opt,name=c,proto3" json:"c,omitempty"`                                 // C parameter
	TGsw              uint64 `protobuf:"varint,10,opt,name=tGsw,proto3" json:"tGsw,omitempty"`                          // GSW parameter
	Q2Bits            uint64 `protobuf:"varint,11,opt,name=q2Bits,proto3" json:"q2Bits,omitempty"`                      // Q2 bits
	TExpLeft          uint64 `protobuf:"varint,12,opt,name=tExpLeft,proto3" json:"tExpLeft,omitempty"`                  // T expansion left
	// Response metadata (from PIR server)
	RecordSize    uint64 `protobuf:"varint,13,opt,name=recordSize,proto3" json:"recordSize,omitempty"` // Size of each record in bytes
	Factor        uint32 `protobuf:"varint,14,opt,name=factor,proto3" json:"factor,omitempty"`         // InsPIRe factor parameter
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InspireParams) GetPolyLen() uint64 {
	if x != nil {
		return x.PolyLen
	}
	return 0
...
func (x *InspireParams) GetDbDim1() uint64 {
	if x != nil {
		return x.DbDim1
	}
	return 0
...
func (x *InspireParams) GetInstances() uint64 {
	if x != nil {
		return x.Instances
	}
	return 0
...
func (x *InspireParams) GetDbRows() uint64 {
	if x != nil {
		return x.DbRows
	}
	return 0
...
func (x *InspireParams) GetDbCols() uint64 {
	if x != nil {
		return x.DbCols
	}
	return 0
...
func (x *InspireParams) GetGamma() uint64 {
	if x != nil {
		return x.Gamma
	}
	return 0
...
func (x *InspireParams) GetInterpolateDegree() uint64 {
	if x != nil {
		return x.InterpolateDegree
	}
	return 0
}

func (x *InspireParams) GetPtModulus() uint64 {
	if x != nil {
		return x.PtModulus
	}
	return 0
...
func (x *InspireParams) GetC() uint64 {
	if x != nil {
		return x.C
	}
	return 0
...
func (x *InspireParams) GetTGsw() uint64 {
	if x != nil {
		return x.TGsw
	}
	return 0
...
func (x *InspireParams) GetQ2Bits() uint64 {
	if x != nil {
		return x.Q2Bits
	}
	return 0
...
func (x *InspireParams) GetTExpLeft() uint64 {
	if x != nil {
		return x.TExpLeft
	}
	return 0
...
func (x *InspireParams) GetRecordSize() uint64 {
	if x != nil {
		return x.RecordSize
	}
	return 0
...
const file_service_proto_rawDesc = "" +
	...
	"\velementSize\x18\x03 \x01(\x04R\velementSize\"\xff\x02\n" +
	"\rInspireParams\x12\x18\n" +
	"\apolyLen\x18\x01 \x01(\x04R\apolyLen\x12\x16\n" +
	"\x06dbDim1\x18\x02 \x01(\x04R\x06dbDim1\x12\x1c\n" +
	"\tinstances\x18\x03 \x01(\x04R\tinstances\x12\x16\n" +
	"\x06dbRows\x18\x04 \x01(\x04R\x06dbRows\x12\x16\n" +
	"\x06dbCols\x18\x05 \x01(\x04R\x06dbCols\x12\x14\n" +
	"\x05gamma\x18\x06 \x01(\x04R\x05gamma\x12,\n" +
	"\x11interpolateDegree\x18\a \x01(\x04R\x11interpolateDegree\x12\x1c\n" +
	"\tptModulus\x18\b \x01(\x04R\tptModulus\x12\f\n" +
	"\x01c\x18\t \x01(\x04R\x01c\x12\x12\n" +
	"\x04tGsw\x18\n" +
	" \x01(\x04R\x04tGsw\x12\x16\n" +
	"\x06q2Bits\x18\v \x01(\x04R\x06q2Bits\x12\x1a\n" +
	"\btExpLeft\x18\f \x01(\x04R\btExpLeft\x12\x1e\n" +
	"\n" +
	"recordSize\x18\r \x01(\x04R\n" +
	"recordSize\x12\x16\n" +
	"\x06factor\x18\x0e \x01(\rR\x06factor\"\xd7\x02\n" +
